...
export class RoleController {
  ...
  @Put()
  update(@Body() body) {
    return wrapperResponse(this.roleService.update(body), '编辑角色成功')
  }

  @Post()
  create(@Body() body) {
    return wrapperResponse(this.roleService.create(body), '新增角色成功')
  }
  ...
  updateAuth(@Body() body) {
    return wrapperResponse(this.roleService.updateAuth(body), '编辑权限成功')
  }
  ...
  removeAuth(@Body() body) {
    return wrapperResponse(this.roleService.removeAuth(body.id), '删除权限成功')
  }
